            ...
            <div class="card-plain">
                <form  action=""  @submit.prevent="handleSubmit()">
                    ...
                    <div class="footer text-center">
                        <button class="btn l-cyan btn-round btn-lg btn-block waves-effect waves-light">SIGN UP</button>
                        <h6 class="m-t-20"><router-link to="/login" class="link">You already have a membership?</router-link></h6>
                    </div>
                </form>
            </div>
        </div>
